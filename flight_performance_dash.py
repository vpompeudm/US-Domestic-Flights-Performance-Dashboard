...
def get_graph(chart, year, c1, c2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            bar_data, line_data, div_data, map_data, tree_data = compute_data_counts(df)
            ...
            avg_car, avg_weather, avg_NAS, avg_sec, avg_late = compute_delay_averages(df)
